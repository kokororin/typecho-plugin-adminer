...
<link rel="stylesheet" type="text/css" href="<?php echo TYPECHO_ADMINER_STATIC_PREFIX;?>/default.css">
<link rel="stylesheet" type="text/css" href="<?php echo TYPECHO_ADMINER_STATIC_PREFIX;?>/adminer.css">
<script type="text/javascript" src="<?php echo TYPECHO_ADMINER_STATIC_PREFIX;?>/functions.js"></script>
<script type="text/javascript" src="<?php echo TYPECHO_ADMINER_STATIC_PREFIX;?>/editing.js"></script>
<?php if ($adminer->head()) { ?>
